				...
				<div class="forms" >
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 	
							...
							<form class="form-horizontal">
							 	<h2 style="text-align: center; margin-top: 15px;">Application for compensatory leave</h2><br>
								...
								<div class="form-group">
									<label  for="remark" class="col-sm-2 control-label">remark if any :</label>
									<div class="col-sm-3">
										<input type="text" name="" class="col-sm-3 form-control1">
									</div>
