	...
	if (isset($_POST['approved']))
{
	...
	$remark = $_POST['pr_remark'];
		...
		$query = "UPDATE mt_leave SET PRINCIPAL_APPROVED = 'Approved',PRINCIPAL_APPROVED_DATE = '$pr_date',PRINCIPAL_REMARKS='$remark',PR_APP_ID='$empname' WHERE LEAVE_ID = '$leave_id' ";
				...
				<div class="forms" >
					...
					<br>
								...
								<label  for="HOD_APPROVED" class="col-sm-4 control-label">HOD APPROVED REMARKS :</label>
									<div class="col-sm-5">
										<input type="text" class="form-control"  name="hod_remark" name="HOD_APPROVED" value="<?php echo "$hod_app_remarks";?>" readonly  > 								
								</div>
								<div class="col-sm-2" >
										<input type="date" class="form-control1" id="date" placeholder="" name="hod_date"
										value="<?php echo "$hod_app_date";?> " readonly>
								</div>
</div>
								
                                
								<div class="form-group" style="margin-top:-30px;">
								<label  for="PR_APPROVED" class="col-sm-4 control-label">PRINCIPAL APPROVED REMARKS :</label>
									<div class="col-sm-5">
