...
if(($l_from != $halfdate )&&($l_to != $halfdate)&&($fn=='half-day'))
	...
	elseif($coff_leave < $total_days)
	...
	else{	$query = "INSERT INTO mt_leave (EMP_NO,L_FROM, L_TO,NO_OF_DAYS,APPLIED_ON,REASON,L_type,HOD_APPROVED,PRINCIPAL_APPROVED,FN) VALUES (?,?,?,?,?,?,?,?,?,?)";
		...
		$query2="INSERT INTO  coff (LEAVE_ID,EMP_NO,type_of_day,atd_emp_no,atd_emp_name,half_day_date,permission) VALUES (?,?,?,?,?,?,?)";
...
<html>
<head>
	<title>APPLICATION FOR COMPENSATORY LEAVE</title>
	<!-- Script -->
				...
				<div class="forms" >
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 	
							...
							<form class="form-horizontal" method="POST" action="#" onsubmit=" confirm('Are you sure you want to submit this form?');">
								<input type="hidden" name="leave_type" value="coff">
									
								 <h2 style="text-align: center; margin-top: 5px;font-sixe:30px;">APPLICATION FOR COMPENSATORY LEAVE FOR <?php echo "$department" ;?></h2><br>
    ...
    $( function() {
        ...
        $( "#autocomplete" ).autocomplete({
            ...
            select: function (event, ui) {
				...
				$('#selectuser_dept').val(ui.item.value1); // save selected id to input
                return false;
            }
        });
            ...
            select: function( event, ui ) {
                ...
                return false;
								...
								<div class=" form-group">
									...
									<div class="col-sm-3">
										<input type="text" id='autocomplete'  name="atd_empname" class=" form-control1" placeholder="Enter Employee Initals" >
									</div>
									<div  class="col-sm-2">
									<input type="text" id='selectuser_id' name="atd_emp_no" class=" form-control1" placeholder="Employee No" readonly/>
									</div>
									<div  class="col-sm-3">
